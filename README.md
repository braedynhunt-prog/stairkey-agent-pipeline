...
hand-write the code — and this post is about the part I did build: the engineering
organization that produced it, where every engineer is an AI agent.*

---

I'm the founder and CTO of Stairkey, a business-management platform for construction and
...
I built it without a human engineering team. Multiple Claude Code agents work the repo in
parallel, around the clock, and my job looks like a CTO's job anywhere: architecture,
...
*Braedyn Hunt is the founder & CTO of Stairkey. If you're working on agentic development
